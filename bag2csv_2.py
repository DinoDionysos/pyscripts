...
def bag2csv_2(bag_name_with_number_without_extension, topic_name, folder_prefix, path_external_ssd, folder_orb):
    ...
    # bag_name_with_number_without_extension is of the form c8_orb_mono_1 or c8_orb_mono_14 or c8_orb_mono_6. if the number at the end is a single digit, we need to add a 0 in front of it
    # if bag_name_with_number_without_extension[-2] == '_':
    #     bag_name_with_number_without_extension = bag_name_with_number_without_extension[:-1] + '0' + bag_name_with_number_without_extension[-1:]
